...
private:
    ...
    void recreateSwapChain() {
        //Pause app if window was minimized
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        //TODO: Change settings below to be app specific
        //Begin render pass
    ...
    void createRenderPass() {
        //TODO: Change settings below depending on app
    ...
    static std::vector<char> readFile(const std::string& filename) {
        ...
        //start from end of file to determine filesize
    ...
    void createGraphicsPipeline() {
        ...
        //Input Assembly, Defined to use triangles
        VkPipelineInputAssemblyStateCreateInfo inputAssembly{};
        inputAssembly.sType = VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO;
        inputAssembly.topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST;
        inputAssembly.primitiveRestartEnable = VK_FALSE;

        //Defines viewport, same size as swapchain
        VkViewport viewport{};
        viewport.x = 0.0f;
        viewport.y = 0.0f;
        ...
        //Defines scissor, same size as viewport
        VkRect2D scissor{};
        scissor.offset = { 0, 0 };
        scissor.extent = swapChainExtent;
        ...
        //Setup Graphics Pipeline Layout
    ...
    void mainLoop() {
        ...
        //Make sure to finish async execution
        vkDeviceWaitIdle(device);
    }

    void drawFrame() {
        //Wait for previous frames to finish
        ...
        //Check result to see if swapchain needs to be recreated
        ...
        //Reset fences (Only if we are submitting work)
        ...
        //Define submit info for command buffer
        VkSubmitInfo submitInfo{};
        submitInfo.sType = VK_STRUCTURE_TYPE_SUBMIT_INFO;

        //Use semaphore "imageAvailableSemaphore" to wait
        ...
        //Define semaphores to signal when execution finishes
